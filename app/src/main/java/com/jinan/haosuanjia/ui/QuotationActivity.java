...
import com.jinan.haosuanjia.ui.framgment.QuotationOneFragment;
import com.jinan.haosuanjia.ui.framgment.QuotationTwoFragment;
...
public class QuotationActivity extends BaseActivity  implements  View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentList.add(QuotationOneFragment.newInstance("0",""));
//        if (!TextUtils.isEmpty(SPUtil.get(Constants.USERID))) {
            fragmentList.add(QuotationTwoFragment.newInstance("1",""));
//        }
