...
import com.jinan.haosuanjia.ui.base.BaseFragmentPagerAdapter;
import com.jinan.haosuanjia.ui.framgment.BussinessOneFragment;
import com.jinan.haosuanjia.ui.framgment.BussinessTwoFragment;
...
public class BusinessActivity extends BaseActivity implements  View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentList.add(BussinessOneFragment.newInstance("0",""));
//        if (!TextUtils.isEmpty(SPUtil.get(Constants.USERID))) {
        fragmentList.add(BussinessTwoFragment.newInstance("1",""));
//        }
